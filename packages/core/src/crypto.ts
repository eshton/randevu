...
/** Verify an Ed25519 signature against an identity public key. Fails closed (false) on
 * any malformed input rather than throwing — a verify predicate should never be a footgun. */
